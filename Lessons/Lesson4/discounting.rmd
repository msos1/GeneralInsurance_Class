...
# Paid_HH_big <- 
# Paid ... ... <- ...
# ake rozne su jednotlive trojuholniky pre jednotlive skupiny...?
# ktory biznis je short tail a ktory long tail? - DU ... teda ktory klesa casom a ktory rastie (trojuholnik)
```
