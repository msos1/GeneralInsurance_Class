...
prediction <- predict(model1a, val, type = "response") # default je type = 'link'
# head(prediction)
# prediction <- predict(model1a, val)
# head(prediction)
```
...
4.  Interaction <!-- napr. spojit pohlavie a vek -->
...
# cislo sa zvacsilo, teda nie vzdy to pomoze
```
...
```{r}
source("C:\\Users\\Matej\\Documents\\github\\GeneralInsurance_Class\\Lessons\\Lesson6\\Support\\emb_chart.R")
emblem_graph(
